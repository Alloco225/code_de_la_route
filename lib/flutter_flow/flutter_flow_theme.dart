...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF009E60);
  ...
  late Color accent2 = const Color(0xFF40E0D0);
  late Color accent3 = const Color(0xFFFFD700);
  late Color accent4 = const Color(0xFFFF6347);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFD96100);
  late Color secondary = const Color(0xFF007E40);
  late Color tertiary = const Color(0xFF333333);
  late Color alternate = const Color(0xFFCCA300);
  ...
  late Color accent2 = const Color(0xFF00CED1);
  late Color accent3 = const Color(0xFFCCA300);
  late Color accent4 = const Color(0xFFFF4500);
  late Color success = const Color(0xFF228B22);
  late Color warning = const Color(0xFFCCA300);

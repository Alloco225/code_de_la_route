...
if (process.browser) window["InfoBubble"] = InfoBubble;
...
InfoBubble.prototype.buildDom_ = function () {
  ...
  close.style["cursor"] = "pointer";
  close.className = "js-info-bubble-close";
  // ? Info bubble closing button styling
  close.innerHTML = '<i class="material-icons-outlined">close</i>';
  close.className =
    "js-info-bubble-close rounded-full p-1 flex justify-center items-center absolute top-5 right-5 bg-white bg-opacity-10 hover:bg-opacity-50";
  //
...
InfoBubble.prototype.draw = function () {
  ...
  this.bubble_.style["top"] = this.px(top -this.topOffset);
  ...
  switch (shadowStyle) {
    case 1:
      // Shadow is behind
      this.bubbleShadow_.style["top"] = this.px(top + tabHeight - 1 - this.topOffset);
